...
class TaskClassifier:
    ...
    KEYWORD_PATTERNS = {
        ...
        "complex_code":      r"implement|build|create|develop|construct|\bwrite\b|\bcode\b",
        ...
        "boilerplate":       r"boilerplate|scaffold|template|skeleton|init|dataclass|schema|crud|getter|setter|pydantic\s+model",
